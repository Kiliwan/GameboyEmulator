 ...
 */
//  0xE0, 0x50 in the two first to shortcut the bootrom
...
/**
 * @brief Macro to unplug bootrom from the bus
 */
#define bootrom_unplug(c, bus) bus_unplug(bus, c);

/**
 * @brief Macro to free bootrom
 */
#define bootrom_free(c) component_free(c);
