...
/**
 * @brief function to update flags based on result
 *
 * @param result alu_output_t pointer to write into
 * @param carry table of carry values
 * @param temp temporary value to take into consideration in some cases
 */
void update_flags(alu_output_t* result, int carry[], int temp);

/**
 * @brief function to update alu_add16 flags
 *
 * @param result alu_output_t pointer to write into
 */
